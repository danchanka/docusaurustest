...
Each [system element](lsFusionElement_identification.md) may have a *name* which can be used to [access](lsFusionSearch.md) the element.
...
You can [find](lsFusionSearch.md) more details on how namespaces are used when [finding](lsFusionSearch.md) elements in the relevant section.

The namespace in which elements are created is determined by the [module](lsFusionModules.md), and cannot be changed in the future. The same limitation applies to additional priority namespaces.
