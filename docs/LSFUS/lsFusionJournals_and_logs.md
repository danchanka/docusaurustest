...
With [automatic installation](lsFusionExecution_auto_.md) under Linux, symlinks for these folders (as well as for the [lsFusion launch parameters](Launch-parameters_65241244.html#Launchparameters-applsfusion)) are automatically created to [other folders](57738078.html#Execution(auto)-logs) whose location is better aligned with Linux ideology.
