...
The **SEEK** operator creates an [action](lsFusionActions.md) that [seeks specified objects](lsFusionSearch_SEEK_.md) on a [form](lsFusionForms.md).
...
An [expression](lsFusionExpression.md) whose value is the required value of the form object.
