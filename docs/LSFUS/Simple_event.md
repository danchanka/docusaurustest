...
-   If the action in a simple event is a single [change](Property_сhange_CHANGE_.md) of a given property, this event is easily made [calculated](Calculated_events.md) and vice versa.
