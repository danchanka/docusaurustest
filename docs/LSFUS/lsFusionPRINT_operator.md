...
The **PRINT** operator creates an [action](lsFusionActions.md) that [opens a form](lsFusionIn_a_print_view_PRINT_.md) in print view. 
...
[Expressions](lsFusionExpression.md) whose values determine the filtered (fixed) values for form objects.
