...
In *static* view, all form data is read at the time the form is [opened](lsFusionOpen_form.md), after which the obtained data is converted:

-   either to [print](lsFusionPrint_view.md) view - image or excel. Print view is also often referred to as a *report*
-   or to [structured](lsFusionStructured_view.md) view - one of the corresponding data formats (e.g. **XML**, **JSON**, **CSV**, **DBF**)
...
<img src="download/temp/svgout1901998409715343268.png" width="653" height="421" />
