...
The **CASE** operator  creates a [property](lsFusionProperties.md) that [selects](lsFusionSelection_CASE_IF_MULTI_OVERRIDE_EXCLUSIVE_.md) a result by condition.
...
 [Expressions](lsFusionExpression.md) whose values define the selection condition. 
