...
[Current values](Form-structure_1573069.html#Formstructure-currentObject) of objects can change either as a result of an action created using the special search operator [(SEEK)](Search_SEEK.md), or as a result of a change to the current row, if an object group is displayed in a table.
