...
-   *form* – [opens](In_an_interactive_view_SHOW_DIALOG.md) a specified [form](Forms.md) in the interactive view and the [asynchronous](36307331.html#Inaninteractiveview(SHOW,DIALOG)-flow) mode.
